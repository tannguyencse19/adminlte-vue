          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 col-12">
              <div class="info-box p-0">
                ...
                <!-- /.info-box-icon -->
                <a href="#tasks" class="info-box-content flex-row align-items-center">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="info-box p-0">
                <span class="info-box-icon bg-danger flex-column">
                  <i class="fas fa-exclamation-triangle"></i>
                  <b class="text-xs">My Problems</b>
                </span>
                <!-- /.info-box-icon -->
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="info-box p-0">
                <span class="info-box-icon bg-success flex-column">
                  ...
                  <b class="text-sm">My Milestones</b>
                </span>
                <!-- /.info-box-icon -->
                <div class="info-box-content flex-row align-items-center">
                  <span class="info-box-text text-green text-bold">Open</span>
                  <span class="info-box-number m-0 ml-1">1</span>
                </div>
                <!-- /.info-box-content -->
                <div class="info-box-content flex-row align-items-center">
                  <span class="info-box-text text-red text-bold">Closed</span>
              ...
              <div class="card">
                <div class="card-header pl-2">
                  <h3 class="card-title text-bold">
                    <span class="text-sm text-orange mr-2">
                ...
                <div class="card-body table-responsive p-0" style="height: 200px">
                  <table class="table table-sm">
                    ...
                    <tbody>
                      <tr data-toggle="modal" data-target="#modal-xl" class="text-hover-orange">
                        <td>1.</td>
        ...
        <div class="modal-content flex-row">
          ...
          <div>
            <div class="modal-header">
              <a class="btn-modal-sidebar" href="#" role="button"><i class="fas fa-bars"></i></a>
              <h4 class="modal-title">Extra Large Modallll</h4>
